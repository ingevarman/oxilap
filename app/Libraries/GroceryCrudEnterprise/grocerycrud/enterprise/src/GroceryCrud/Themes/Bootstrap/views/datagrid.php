<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.9.0.93710ae.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.9.0.93710ae' . $minify_or_not . '.js');
